#' Make a dataframe with evalues in -log10
#'
#' @param Enzymefamily a name of the family copy seed
#' @param matriz_resultante shrt dataframe wit names of family, genomes and
#' evalue
#'
