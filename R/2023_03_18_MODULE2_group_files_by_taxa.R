...
inputdir<-"data/my_directory_2023-03-22"
IDs_file<-"data/Saccharospirillaceae_bins.IDs"

#group_files_by_taxa<-function(inputdir,taxa,IDs_file){
...
get_dir_name <- function() {
  ...
  return(paste0("data/",fam_name,"_bins_", today))
}
...
#}
#group_files_by_taxa("data/my_directory_2023-03-22","f__Saccharospirillaceae","data/Saccharospirillaceae_bins.IDs")
q#Hyphomonadaceae_bins.IDs
