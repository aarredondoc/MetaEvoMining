...
#variables------------------------------------------------------------------####
evominining_table <- read_tsv('Alteromonadaceae_evomining_table - AAD_DB.tsv')#dataframe
...
write.table(nameskeepcol, "runtreeevo_Alteromonadaceae_AAD_DB.txt", sep = "\t", row.names = FALSE, col.names = FALSE,quote = FALSE)
