...
#' @export
make_rastIDs_by_taxa<-function(gtdbK_report,taxa){
#library("readr")
# cargamos archive---------------------------------------------------------####
...
# Se corre un loop para una lista y se escribe un archivo -----------------####
#library(dplyr)
#library(plyr)
#library(tidyverse)
...
write.table(taxon_ids , file =  paste("data/",fam_name,"_bins.IDs", sep = ""), sep = "\t", dec = ".",
            row.names = FALSE, col.names = FALSE, quote=FALSE)
}

#make_rastIDs_by_taxa('data/gtdbtk.bac120.summary.tsv',"f__Saccharospirillaceae")
